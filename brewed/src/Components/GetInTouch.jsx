  ...
  return (
    <div className="bg-gray-100 py-16 px-5 lg:px-60">
      <div className="text-center">
        <h1 className="text-4xl text-gray-800 font-bold font-Kanit mb-10">
          GET IN TOUCH
        </h1>
        ...
        <button className="text-red-600 mt-10 text-xs md:text-sm lg:text-base w-32 md:w-40 lg:w-52 font-Kanit border border-red-600 hover:bg-red-600 hover:text-white hover:border-white duration-200 rounded-full px-4 md:px-6 lg:px-8 py-2 md:py-3 lg:py-4">
          SEND
        </button>
      </div>
    </div>
